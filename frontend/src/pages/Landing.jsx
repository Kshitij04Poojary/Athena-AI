...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-100 to-indigo-100 flex flex-col items-center justify-center p-6">
      ...
      {/* Hero Section */}
      <div className="text-center max-w-4xl mt-24 animate-fadeIn">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Link
            to="/register"
            className="px-8 py-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300 text-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Sign Up for Free
          </Link>
          <Link
            to="/login"
            className="px-8 py-4 border-2 border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition duration-300 text-lg font-medium shadow-md hover:shadow-lg transform hover:-translate-y-1"
          >
            Login
          </Link>
        </div>
      ...
      {/* Stats Section */}
      <div className="mt-16 w-full max-w-6xl bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="mt-16 w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-indigo-100">
            <h3 className="text-2xl font-semibold text-indigo-900 mb-4">For Students</h3>
            ...
            <Link to="/register" className="mt-6 inline-block px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300">
              Join as a Student
            </Link>
          </div>
          
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-blue-100">
            <h3 className="text-2xl font-semibold text-blue-900 mb-4">For Mentors</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
            ...
            <Link to="/register" className="mt-6 inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300">
              Join as a Mentor
            </Link>
          </div>
        </div>
      ...
      {/* Call to Action */}
      <div className="mt-16 w-full max-w-4xl bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-lg p-10 text-center text-white">
        <h2 className="text-3xl font-bold mb-4">Ready to Transform Your Learning Journey?</h2>
        <p className="text-xl mb-6">Join thousands of students and mentors already on the platform.</p>
        <Link
          to="/register"
          className="px-8 py-4 bg-white text-indigo-600 rounded-lg hover:bg-indigo-50 transition duration-300 text-lg font-medium shadow-lg"
        >
      ...
      {/* Footer */}
      <footer className="mt-20 w-full max-w-7xl text-center text-gray-600 border-t border-gray-200 pt-6">
