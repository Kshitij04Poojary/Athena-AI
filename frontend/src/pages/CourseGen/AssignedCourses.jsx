                    ...
                    <div className="flex justify-between items-center">
                        ...
                        {assignedCourses.length > 0 && (
                            <div className="bg-white/20 text-white px-4 py-2 rounded-full font-medium backdrop-blur-sm">
                                {assignedCourses.length} course{assignedCourses.length !== 1 ? 's' : ''} assigned to you
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="p-6">
                    {isLoading ? (
                        ...
                        <div className="text-center py-12 text-gray-500 h-64 flex flex-col justify-center">
                            <p className="text-xl mb-4">No assigned courses</p>
                            <p>Your mentor hasn't assigned any courses to you yet.</p>
                        </div>
                    ) : (
                                ...
                                >
                                    <div className="p-5 h-full flex flex-col">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-500 mb-4">Assigned on {course.assignedDate}</p>
                                        </div>
