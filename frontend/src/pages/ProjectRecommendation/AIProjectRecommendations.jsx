...
const AIProjectRecommendations = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen md:p-8 px-6 py-3 font-sans mt-[50px]">
      <div className="max-w-6xl mx-auto">
        {projectRecommendations.length === 0 && !loading ? (
          <div className="flex flex-col justify-center items-center text-center min-h-[60vh] bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
