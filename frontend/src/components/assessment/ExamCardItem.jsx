...
const ExamCardItem = ({ quiz, userSelectedOption, selectedOption }) => {
  return (
    <div className="mt-2 ">
      <h2 className="font-medium text-2xl text-gray-800 mb-8">{quiz?.question}</h2>
        ...
        {quiz.options.map((option, index) => (
          ...
          >
            ...
            <div className="flex items-center">
              <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mr-4 transition-all duration-300 ${
                selectedOption === option 
